...
function Kalandmester() {
  ...
  return (<>
      ...
      <button id='setIntervalButton' className={styles.saveButton} onClick={setGameIdInputInterval} type='button'>Harc!</button>
      <button id='removeIntervalButton' className={styles.saveButton} onClick={removeGameIdInputInterval} type='button'>Harc vége!</button>
      </div>
