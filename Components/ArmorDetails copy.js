          ...
          <div>
            ...
            <ul id="armorList" className={styles.topPart}>
              <li id="currentHelmetLi" className={styles.armorListItem}>
                <input id="currentHelmetCheckBox" type="checkBox" onChange={handleArmorOnOrOff} className={styles.currentArmorCheckBox} />
                <span className={styles.currentArmorName} id="currentHelmetName">
                  Fej: Nincs
                </span>
              </li>
              <li id="currentUpperTorsoLi" className={styles.armorListItem}>
                <input id="currentUpperTorsoCheckBox" type="checkBox" onChange={handleArmorOnOrOff} className={styles.currentArmorCheckBox} />
                <span className={styles.currentArmorName} id="currentUpperTorsoName">
                  Mellkas: Nincs
                </span>
              </li>
              <li id="currentLowerTorsoLi" className={styles.armorListItem}>
                <input id="currentLowerTorsoCheckBox" type="checkBox" onChange={handleArmorOnOrOff} className={styles.currentArmorCheckBox} />
                <span className={styles.currentArmorName} id="currentLowerTorsoName">
                  Has: Nincs
                </span>
              </li>
              <li id="currentArmsLi" className={styles.armorListItem}>
                <input id="currentArmsCheckBox" type="checkBox" onChange={handleArmorOnOrOff} className={styles.currentArmorCheckBox} />
                <span className={styles.currentArmorName} id="currentArmsName">
                  Karok: Nincs
                </span>
              </li>
              <li id="currentLeggingsLi" className={styles.armorListItem}>
                <input id="currentLeggingsCheckBox" type="checkBox" onChange={handleArmorOnOrOff} className={styles.currentArmorCheckBox} />
